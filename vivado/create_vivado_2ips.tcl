...
set ip1 [create_bd_cell -type ip -vlnv xilinx.com:hls:conv1_pool1:1.0 conv1_pool1_0]
set ip2 [create_bd_cell -type ip -vlnv xilinx.com:hls:conv2_pool2:1.0 conv2_pool2_0]
...
puts "===================================================="
puts "TERMINE."
puts "Fichiers : pynq_output/design_1_wrapper.{bit,hwh}"
puts "===================================================="