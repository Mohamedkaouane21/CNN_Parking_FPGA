...
extern "C" void conv1_pool1(Byte<64>*, Byte<4>*, int, int);
extern "C" void apatb_conv1_pool1_hw(volatile void * __xlx_apatb_param_in_r, volatile void * __xlx_apatb_param_out_r) {
using hls::sim::createStream;
  // Collect __xlx_in_r__tmp_vec
std::vector<Byte<64>> __xlx_in_r__tmp_vec;
for (size_t i = 0; i < 144; ++i){
__xlx_in_r__tmp_vec.push_back(((Byte<64>*)__xlx_apatb_param_in_r)[i]);
}
  int __xlx_size_param_in_r = 144;
...
for (size_t i = 0; i < 8464; ++i){
__xlx_out_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_out_r)[i]);
}
  int __xlx_size_param_out_r = 8464;
  int __xlx_offset_param_out_r = 0;
  int __xlx_offset_byte_param_out_r = 0*4;
  // DUT call
  conv1_pool1(__xlx_in_r__tmp_vec.data(), __xlx_out_r__tmp_vec.data(), __xlx_offset_byte_param_in_r, __xlx_offset_byte_param_out_r);
// print __xlx_apatb_param_in_r
for (size_t i = 0; i < __xlx_size_param_in_r; ++i) {
((Byte<64>*)__xlx_apatb_param_in_r)[i] = __xlx_in_r__tmp_vec[__xlx_offset_param_in_r+i];
}
