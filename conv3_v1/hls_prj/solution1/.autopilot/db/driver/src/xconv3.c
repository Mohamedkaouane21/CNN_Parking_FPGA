...
void XConv3_Continue(XConv3 *InstancePtr) {
    ...
    Data = XConv3_ReadReg(InstancePtr->Control_BaseAddress, XCONV3_CONTROL_ADDR_AP_CTRL) & 0x80;
    XConv3_WriteReg(InstancePtr->Control_BaseAddress, XCONV3_CONTROL_ADDR_AP_CTRL, Data | 0x10);
}
...
void XConv3_Set_in_r(XConv3 *InstancePtr, u64 Data) {
    ...
    XConv3_WriteReg(InstancePtr->Control_BaseAddress, XCONV3_CONTROL_ADDR_IN_R_DATA, (u32)(Data));
    XConv3_WriteReg(InstancePtr->Control_BaseAddress, XCONV3_CONTROL_ADDR_IN_R_DATA + 4, (u32)(Data >> 32));
}
...
u64 XConv3_Get_in_r(XConv3 *InstancePtr) {
    ...
    Data = XConv3_ReadReg(InstancePtr->Control_BaseAddress, XCONV3_CONTROL_ADDR_IN_R_DATA);
    Data += (u64)XConv3_ReadReg(InstancePtr->Control_BaseAddress, XCONV3_CONTROL_ADDR_IN_R_DATA + 4) << 32;
    return Data;
}
...
void XConv3_Set_out_r(XConv3 *InstancePtr, u64 Data) {
    ...
    XConv3_WriteReg(InstancePtr->Control_BaseAddress, XCONV3_CONTROL_ADDR_OUT_R_DATA, (u32)(Data));
    XConv3_WriteReg(InstancePtr->Control_BaseAddress, XCONV3_CONTROL_ADDR_OUT_R_DATA + 4, (u32)(Data >> 32));
}
...
u64 XConv3_Get_out_r(XConv3 *InstancePtr) {
    ...
    Data = XConv3_ReadReg(InstancePtr->Control_BaseAddress, XCONV3_CONTROL_ADDR_OUT_R_DATA);
    Data += (u64)XConv3_ReadReg(InstancePtr->Control_BaseAddress, XCONV3_CONTROL_ADDR_OUT_R_DATA + 4) << 32;
    return Data;
}
