set moduleName conv3_Pipeline_LOAD_IC_LOAD_IY
set isTopModule 0
...
set cdfgNum 5
set C_modelName {conv3_Pipeline_LOAD_IC_LOAD_IY}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict in_buf { MEM_WIDTH 32 MEM_SIZE 5120 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict in_buf_1 { MEM_WIDTH 32 MEM_SIZE 5120 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict in_buf_2 { MEM_WIDTH 32 MEM_SIZE 5120 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ AXI_IN int 64 regular {axi_master 0}  }
	{ sext_ln28 int 61 regular  }
	{ in_buf float 32 regular {array 1280 { 0 3 } 0 1 }  }
	{ in_buf_1 float 32 regular {array 1280 { 0 3 } 0 1 }  }
	{ in_buf_2 float 32 regular {array 1280 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "AXI_IN", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln28", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_AXI_IN_0_WDATA sc_out sc_lv 64 signal 0 } 
	{ m_axi_AXI_IN_0_WSTRB sc_out sc_lv 8 signal 0 } 
	...
	{ m_axi_AXI_IN_0_RDATA sc_in sc_lv 64 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axi_AXI_IN_0_WDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "AXI_IN", "role": "0_WDATA" }} , 
 	{ "name": "m_axi_AXI_IN_0_WSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "AXI_IN", "role": "0_WSTRB" }} , 
 	...
 	{ "name": "m_axi_AXI_IN_0_RDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "AXI_IN", "role": "0_RDATA" }} , 
 	...
 	{ "name": "sext_ln28", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln28", "role": "default" }} , 
...
set Spec2ImplPortList { 
	 { m_axi {  { m_axi_AXI_IN_0_AWVALID VALID 1 1 }  { m_axi_AXI_IN_0_AWREADY READY 0 1 }  { m_axi_AXI_IN_0_AWADDR ADDR 1 64 }  { m_axi_AXI_IN_0_AWID ID 1 1 }  { m_axi_AXI_IN_0_AWLEN SIZE 1 32 }  { m_axi_AXI_IN_0_AWSIZE BURST 1 3 }  { m_axi_AXI_IN_0_AWBURST LOCK 1 2 }  { m_axi_AXI_IN_0_AWLOCK CACHE 1 2 }  { m_axi_AXI_IN_0_AWCACHE PROT 1 4 }  { m_axi_AXI_IN_0_AWPROT QOS 1 3 }  { m_axi_AXI_IN_0_AWQOS REGION 1 4 }  { m_axi_AXI_IN_0_AWREGION USER 1 4 }  { m_axi_AXI_IN_0_AWUSER DATA 1 1 }  { m_axi_AXI_IN_0_WVALID VALID 1 1 }  { m_axi_AXI_IN_0_WREADY READY 0 1 }  { m_axi_AXI_IN_0_WDATA FIFONUM 1 64 }  { m_axi_AXI_IN_0_WSTRB STRB 1 8 }  { m_axi_AXI_IN_0_WLAST LAST 1 1 }  { m_axi_AXI_IN_0_WID ID 1 1 }  { m_axi_AXI_IN_0_WUSER DATA 1 1 }  { m_axi_AXI_IN_0_ARVALID VALID 1 1 }  { m_axi_AXI_IN_0_ARREADY READY 0 1 }  { m_axi_AXI_IN_0_ARADDR ADDR 1 64 }  { m_axi_AXI_IN_0_ARID ID 1 1 }  { m_axi_AXI_IN_0_ARLEN SIZE 1 32 }  { m_axi_AXI_IN_0_ARSIZE BURST 1 3 }  { m_axi_AXI_IN_0_ARBURST LOCK 1 2 }  { m_axi_AXI_IN_0_ARLOCK CACHE 1 2 }  { m_axi_AXI_IN_0_ARCACHE PROT 1 4 }  { m_axi_AXI_IN_0_ARPROT QOS 1 3 }  { m_axi_AXI_IN_0_ARQOS REGION 1 4 }  { m_axi_AXI_IN_0_ARREGION USER 1 4 }  { m_axi_AXI_IN_0_ARUSER DATA 1 1 }  { m_axi_AXI_IN_0_RVALID VALID 0 1 }  { m_axi_AXI_IN_0_RREADY READY 1 1 }  { m_axi_AXI_IN_0_RDATA FIFONUM 0 64 }  { m_axi_AXI_IN_0_RLAST LAST 0 1 }  { m_axi_AXI_IN_0_RID ID 0 1 }  { m_axi_AXI_IN_0_RFIFONUM LEN 0 9 }  { m_axi_AXI_IN_0_RUSER DATA 0 1 }  { m_axi_AXI_IN_0_RRESP RESP 0 2 }  { m_axi_AXI_IN_0_BVALID VALID 0 1 }  { m_axi_AXI_IN_0_BREADY READY 1 1 }  { m_axi_AXI_IN_0_BRESP RESP 0 2 }  { m_axi_AXI_IN_0_BID ID 0 1 }  { m_axi_AXI_IN_0_BUSER DATA 0 1 } } }
	sext_ln28 { ap_none {  { sext_ln28 in_data 0 61 } } }
	in_buf { ap_memory {  { in_buf_address0 mem_address 1 11 }  { in_buf_ce0 mem_ce 1 1 }  { in_buf_we0 mem_we 1 1 }  { in_buf_d0 mem_din 1 32 } } }
	in_buf_1 { ap_memory {  { in_buf_1_address0 mem_address 1 11 }  { in_buf_1_ce0 mem_ce 1 1 }  { in_buf_1_we0 mem_we 1 1 }  { in_buf_1_d0 mem_din 1 32 } } }
	in_buf_2 { ap_memory {  { in_buf_2_address0 mem_address 1 11 }  { in_buf_2_ce0 mem_ce 1 1 }  { in_buf_2_we0 mem_we 1 1 }  { in_buf_2_d0 mem_din 1 32 } } }
}
