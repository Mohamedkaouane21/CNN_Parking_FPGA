...
// wrapc file define:
#define AUTOTB_TVIN_in_r "../tv/cdatafile/c.conv2_pool2.autotvin_in_r.dat"
#define AUTOTB_TVOUT_in_r "../tv/cdatafile/c.conv2_pool2.autotvout_in_r.dat"
#define AUTOTB_TVIN_out_r "../tv/cdatafile/c.conv2_pool2.autotvin_out_r.dat"
#define AUTOTB_TVOUT_out_r "../tv/cdatafile/c.conv2_pool2.autotvout_out_r.dat"
#define AUTOTB_TVIN_AXI_IN "../tv/cdatafile/c.conv2_pool2.autotvin_AXI_IN.dat"
#define AUTOTB_TVOUT_AXI_IN "../tv/cdatafile/c.conv2_pool2.autotvout_AXI_IN.dat"
#define AUTOTB_TVIN_AXI_OUT "../tv/cdatafile/c.conv2_pool2.autotvin_AXI_OUT.dat"
#define AUTOTB_TVOUT_AXI_OUT "../tv/cdatafile/c.conv2_pool2.autotvout_AXI_OUT.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_AXI_IN "../tv/rtldatafile/rtl.conv2_pool2.autotvout_AXI_IN.dat"
#define AUTOTB_TVOUT_PC_AXI_OUT "../tv/rtldatafile/rtl.conv2_pool2.autotvout_AXI_OUT.dat"
...
extern "C"
void conv2_pool2_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_conv2_pool2_hw(void* __xlx_apatb_param_in_r, void* __xlx_apatb_param_out_r)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_AXI_IN),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_AXI_IN),
#endif
#endif
    .hasWrite = { false },
  };
  port2.param = { __xlx_apatb_param_in_r };
  port2.mname = { "in_r" };
  port2.nbytes = { 33856 };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_AXI_OUT),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_AXI_OUT),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_AXI_OUT),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_AXI_OUT),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_AXI_OUT),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_AXI_OUT),
#endif
#endif
    .hasWrite = { true },
  };
  ...
  try {
    ...
    conv2_pool2_hw_stub_wrapper(__xlx_apatb_param_in_r, __xlx_apatb_param_out_r);
