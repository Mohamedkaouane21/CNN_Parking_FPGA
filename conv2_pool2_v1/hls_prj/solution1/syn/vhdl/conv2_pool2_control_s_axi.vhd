...
entity conv2_pool2_control_s_axi is
generic (
...
end entity conv2_pool2_control_s_axi;
...
architecture behave of conv2_pool2_control_s_axi is
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_in_r(63 downto 32) <= (others => '0');
            elsif (ACLK_EN = '1') then
